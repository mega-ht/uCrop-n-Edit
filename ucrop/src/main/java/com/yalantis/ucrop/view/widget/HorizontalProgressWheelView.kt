 ...
 */
class HorizontalProgressWheelView
    @JvmOverloads
    constructor(
        context: Context?,
        ...
        fun setMiddleLineColor(
            @ColorInt middleLineColor: Int,
        ) {
        ...
        private fun init() {
            ...
            mProgressLinePaint!!.color = ContextCompat.getColor(this.context, R.color.ucrop_color_progress_wheel_line)
